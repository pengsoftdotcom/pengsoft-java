...
/**
 * {@link CashierData} read lisener
 * 
 * @author peng.dang@pengsoft.com
 * @since 1.0.0
 */
public class CashierDataReadListener implements ReadListener<CashierData> {
    ...
    @Override
    public void invoke(CashierData data, AnalysisContext context) {
